...
group2 = LabelFrame(root, text="Điều Khiển", padx=40, pady=40)
group2.grid(row=0, column=1, padx=20, pady=20, sticky=E+W+N+S)
lbl_dk = Label(group2, text = "Setup", font=("Arial Bold", 20))
lbl_dk.grid(row = 0, column = 0, sticky=W)
